...
# Get the quadrants
q1, q2, q3, q4 = get_quadrants(grid)
print("\nQuadrant 1 (Top Left):")
print(q1)
...
quadrant_sums = sum_quadrants(grid)

print("\nQuadrant sums:")
for quadrant, sum_value in quadrant_sums.items():
    print(f"{quadrant}: {sum_value}")

# Calculate safety factor (product of all quadrant sums)
safety_factor = reduce(operator.mul, quadrant_sums.values(), 1)
print(f"\nSafety factor (product of quadrant sums): {safety_factor}")